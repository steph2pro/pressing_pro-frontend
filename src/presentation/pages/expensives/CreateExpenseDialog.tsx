...
import { DepenseCategorie } from '../../../data/models/expenses'
import { LoadingSpinner } from '../../components/ui/LoadingSpinner'
import { useCreateExpense } from '../../hooks/expensives/useCreateExpense'
...
export const CreateExpenseDialog: React.FC<CreateExpenseDialogProps> = ({
  ...
  const { createExpense, loading, error, success } = useCreateExpense()
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const payload = {
      ...
      categorie: formData.categorie as DepenseCategorie,
      montant: parseFloat(formData.montant),
      commentaire: formData.commentaire || undefined,
      justificatif: formData.justificatif || undefined
    }
